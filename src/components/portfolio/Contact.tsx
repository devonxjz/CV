...
const FacebookIcon = () => (
  <svg viewBox="0 0 16 16" fill="currentColor">
    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0 0 3.603 0 8.05 0 12.067 2.928 15.396 6.75 16v-5.624H4.718V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258V8.05h2.218l-.354 2.326H9.25V16c3.822-.604 6.75-3.934 6.75-7.951z" />
  </svg>
);
...
const Contact = ({ contact }: ContactProps) => {
  const links = [
    ...
    { label: 'Email', url: contact.email ? `mailto:${contact.email}` : '', icon: <EmailIcon /> },
